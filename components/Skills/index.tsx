    ...
    <>
      ...
      <ul className="skills">
        ...
        <li>
          ...
          <p>2. 了解并使用 G6 搭建关系图表</p>
          <p>3. 了解并使用 D3 实现底层可视化图表</p>
        </li>
        <li>
          <SkillTitle> Webpack / Rollup</SkillTitle>
          <p>1. 熟练使用 Webpack 对项目进行模块打包并了解其原理</p>
          <p>2. 熟练进行 Webpack 打包性能优化</p>
          <p>3. 了解 Rollup 进行模块化打包流程及原理</p>
        </li>
        <li>
          <SkillTitle> 敏捷开发：</SkillTitle>
          <p>1. 能够熟练使用 rebase、cherry-pick 等 Git 命令，了解 CI、CD 流程</p>
        </li>
      </ul>
    </>
  );
